...
/**
 * ISO 3166-1 alpha-2 country codes for church place.country validation + dropdowns.
 * Labels are resolved via lang countries.* when present; otherwise the code is shown.
 */
return [
