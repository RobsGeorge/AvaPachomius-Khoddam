...
**Current phase: T5 in progress.** T0–T4 landed (dormant while `MULTI_TENANT=false`).
T5 = priests, confession calendars, home-visit schedules. Polymorphic applications /
