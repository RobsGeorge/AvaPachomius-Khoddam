...
|---|---|---|---|---|
| UC-FB-01 | Instructor | Build a survey (questions/types, anonymous/named, optional block of one exam or project); MCQ may allow multiple answers and/or an Other text box; publish | Unpublished not shown to students | `feedback.manage` |
...
**Coverage:** `FeedbackSurveyRouteTest`; `FeedbackSurveyMcqOptionsTest`; announce/survey score gate + anonymity/reveal in feature tests. Gated in `AuthorizationMatrixTest`.
