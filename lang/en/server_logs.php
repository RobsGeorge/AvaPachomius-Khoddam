...
return [
    'title' => 'Server logs',
    'intro' => 'The raw log files written by the server. Newest entries first.',
    'warning' => 'Log entries can contain personal data and internal paths. Do not share screenshots outside the platform team.',
