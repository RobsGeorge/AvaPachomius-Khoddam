...
<div class="content-form-container">
    ...
    <h1 class="form-title">{{ __('pages.add_new_content') }}</h1>
        ...
        <form action="{{ route('contents.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('session_title') is-invalid @enderror" 
                       id="session_title" name="session_title" value="{{ old('session_title') }}" required>
                @error('session_title')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('lecture_name') is-invalid @enderror" 
                       id="lecture_name" name="lecture_name" value="{{ old('lecture_name') }}" required>
                @error('lecture_name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('speaker_name') is-invalid @enderror" 
                       id="speaker_name" name="speaker_name" value="{{ old('speaker_name') }}" required>
                @error('speaker_name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control @error('audio_link') is-invalid @enderror" 
                       id="audio_link" name="audio_link" value="{{ old('audio_link') }}" 
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control @error('slides_link') is-invalid @enderror" 
                       id="slides_link" name="slides_link" value="{{ old('slides_link') }}" 
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          placeholder="{{ __('pages.content_description_long') }}">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <button type="submit" class="btn-submit">
                <i class="fas fa-save"></i> {{ __('pages.save_content') }}
            </button>
        </form>
    </div>
</div>
