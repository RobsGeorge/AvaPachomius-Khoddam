...
use App\Http\Controllers\SuperAdminServerLogController;
...
Route::middleware(['auth', 'superadmin'])->prefix('superadmin')->name('superadmin.')->group(function () {
    ...
    Route::get('/server-logs',               [SuperAdminServerLogController::class, 'index'])->name('server-logs.index');
    ...
    Route::put('/courses/{id}',              [SuperAdminController::class, 'updateCourse'])->name('courses.update');
